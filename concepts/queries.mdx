...
<Warning>
  Do not ask Blazar to extract name fields (e.g., company name, person name). Blazar extracts entity names by default — they always appear as the first column. Requesting names as a field wastes your tokens and compute for no benefit.
</Warning>
