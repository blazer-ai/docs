...
| --------- | ----------- | ------- |
| **Value** | The data point displayed in the table cell | "Ranked #137 in Best Global Universities" |
| **Source URL** | The web page where the information was found | `https://www.usnews.com/education/...` |
| **Citation text** | The exact passage from the source that supports the value | "University of Padua is ranked #137 in Best Global Universities." |
...
<Frame caption="The citation panel showing sources for a selected table cell.">
  <img src="/images/placeholder-citation-panel.png" alt="Blazar citation panel showing source URLs and quoted passages" />
</Frame>
