...
- **Take it elsewhere when you need to.** Export to CSV or XLSX, or read the table through the [API](/api) or [MCP](/mcp-server).
...
Everything above is something an agent can do for you. Connect the [MCP server](/mcp-server) and your assistant works the same table you're looking at — topping the list up with accounts you don't have yet, qualifying them against your criteria, and advancing them through your stages.
