...
<Frame caption="The Blazar empty state with the 'Create new table' shortcut.">
  <img src="/images/empty-state.png" alt="Blazar empty workspace showing the Blazar logo and Create new table shortcut" />
</Frame>
...
<Frame caption="A completed Blazar table with research results and citations.">
  <img src="/images/example-table.png" alt="Blazar table showing entities, columns, result values, and a citation panel on the right" />
</Frame>
